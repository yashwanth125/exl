...
const form_ = require('./images/form2.json')
...
class VehicleInsurance extends ComponentDialog 
{
    constructor(userState)
    {
        super('vehicleInsurance');
...
async firstStep(step) 
{
    ...
    return await step.prompt(CHOICE_PROMPT, {
        prompt: 'Do you want to know the Check list for Car Insurance ?',
...
async ipdStep(step)
{
    ...
    {
        await step.context.sendActivity({attachments: [CardFactory.adaptiveCard(car_)]});
        return await step.prompt(CHOICE_PROMPT, {
            prompt: 'Do you want to know our Car Insurance Policies ?',
            choices:['Yes', 'No']
        });
    }
}
...
module.exports.VehicleInsurance = VehicleInsurance;
